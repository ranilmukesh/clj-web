        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/collections" className="text-muted-foreground hover:text-secondary">Collections</Link></li>
              <li><Link href="/rings" className="text-muted-foreground hover:text-secondary">Rings</Link></li>
              <li><Link href="/necklaces" className="text-muted-foreground hover:text-secondary">Necklaces</Link></li>
              <li><Link href="/earrings" className="text-muted-foreground hover:text-secondary">Earrings</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold mb-4">About</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/about" className="text-muted-foreground hover:text-secondary">Our Story</Link></li>
              <li><Link href="/contact" className="text-muted-foreground hover:text-secondary">Contact Us</Link></li>
              <li><Link href="/faq" className="text-muted-foreground hover:text-secondary">FAQ</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold mb-4">Policies</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/privacy-policy" className="text-muted-foreground hover:text-secondary">Privacy Policy</Link></li>
              <li><Link href="/shipping-exchange" className="text-muted-foreground hover:text-secondary">Shipping & Exchange</Link></li>
            </ul>
          </div>
        </div>
                ...
                <div className="flex flex-wrap items-center text-sm text-muted-foreground">
                  {section.keywords.map((keyword, index) => (
                    <React.Fragment key={keyword}>
                      <Link href="#" className="hover:text-secondary hover:underline py-1">
                        {keyword}
                      </Link>
